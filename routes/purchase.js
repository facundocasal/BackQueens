...
const { getPurchases, createPaymentmercado , getQueensPurchase, getGaleryPuchaseUser , getuserPurchase,  createPaymentpaypal , paypalOrder, getPurchaseById  } = require('../controllers/purchase')
